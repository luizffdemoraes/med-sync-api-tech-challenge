package br.com.fiap.postech.medsync.auth.application.dtos.requests;


import br.com.fiap.postech.medsync.auth.infrastructure.persistence.entity.UserEntity;
import br.com.fiap.postech.medsync.auth.infrastructure.validations.UniqueValue;
...
public record UserRequest(
        ...
        @Pattern(
                ...
                message = "Role must be one of: ROLE_DOCTOR, ROLE_NURSE, ROLE_PATIENT"
        )
        String role,
