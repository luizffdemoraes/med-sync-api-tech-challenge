...
INSERT INTO scheduling.users (username, password, role, name, email) VALUES
                                                                         ('dr.silva', '$2a$10$exampleHash', 'DOCTOR', 'Dr. Carlos Silva', 'carlos.silva@hospital.com'),
...
INSERT INTO scheduling.doctors (user_id, crm, specialty, department) VALUES
    (1, 'CRM-SP123456', 'Cardiologia', 'Cardiologia');

INSERT INTO scheduling.patients (user_id, cpf, phone, birth_date) VALUES
    (3, '12345678901', '(11) 99999-9999', '1985-05-15');
